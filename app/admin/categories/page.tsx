...
import { CategoryStatusButton, IndustryAudienceControl, IndustryCreateForm, IndustryHyperlocalControl } from "@/components/admin/admin-actions";
    ...
    <section className="industry-admin-grid" aria-label="Industry launch controls">
      {industries.map((industry) => {
        ...
        return <article className={`panel industry-admin-card${industry.active ? " is-live" : ""}`} key={industry.id}>
          ...
          <IndustryHyperlocalControl id={industry.id} enabled={industry.hyperlocalEnabled}/>
