...
export const metadata: Metadata = { title: "Customer terms | Bridge AI", description: "Terms for customers requesting supplier quotations through Bridge AI on WhatsApp." };

export default function CustomerTermsPage() {
  return <LegalDocument title="Customer WhatsApp terms" summary="These terms apply when a customer asks Bridge AI to source quotations by WhatsApp. Customers do not create or use portal accounts.">
    <LegalSection id="service" title="1. The service">
      <p>{BRIDGE_AI_COMPANY.name} operates Bridge AI as a sourcing and quotation-matching service. You can describe what you need and send photos, drawings or documents. Bridge AI may use AI to interpret the request, ask questions, prepare a summary and find suitable approved suppliers.</p>
      <p>Bridge AI does not currently charge customers a fee to request quotations. Normal WhatsApp or mobile data charges from your provider may apply.</p>
    </LegalSection>
    <LegalSection id="your-information" title="2. Information you send">
      ...
      <p>You must check Bridge AI’s summary and correct any misunderstanding before confirming publication. Images and AI interpretations are not a substitute for a survey, engineering review or final technical specification.</p>
    </LegalSection>
    ...
    <LegalSection id="liability" title="7. Liability and contact">
      <p>Nothing excludes liability that cannot legally be excluded. Subject to that, Bridge AI is not liable for an independent supplier’s goods, services, statements or failure to perform, or for losses caused by inaccurate customer information. These terms are governed by the law of England and Wales.</p>
