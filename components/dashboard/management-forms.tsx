...
type CoveragePlanView = { name: string; tier: string; maximumRadiusMiles: number | null; nationwideAllowed: boolean; maximumActiveOpportunities: number; onboardingDefault: boolean } | null;
