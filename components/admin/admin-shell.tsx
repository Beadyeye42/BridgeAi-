...
import { Activity, Building2, FileText, FolderTree, LayoutDashboard, MapPin, ShieldAlert } from "lucide-react";
import { BrandMark } from "@/components/brand-mark";

const links=[["Overview","/admin",LayoutDashboard],["Suppliers","/admin/suppliers",Building2],["Quote requests","/admin/requests",FileText],["Categories","/admin/categories",FolderTree],["Coverage areas","/admin/coverage",MapPin],["Activity logs","/admin/audit",Activity],["System events","/admin/system",ShieldAlert]] as const;
