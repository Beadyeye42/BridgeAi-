...
export const metadata: Metadata = { title: "Cookie notice | Bridge-iT", description: "Cookies and similar technologies used by Bridge-iT." };

export default function CookiesPage() {
  return <LegalDocument title="Cookie notice" summary="Bridge-iT currently uses cookies needed to keep accounts secure, remember sessions and preserve a supplier referral when somebody follows an affiliate link.">
    ...
    <LegalSection id="used" title="2. What Bridge-iT uses">
    ...
    <LegalSection id="changes" title="4. Changes and contact">
      <p>We update this notice if the cookies or providers used by Bridge-iT change. Questions can be sent to <a href={`mailto:${BRIDGE_AI_COMPANY.contactEmail}`}>{BRIDGE_AI_COMPANY.contactEmail}</a>. Personal information associated with cookies is handled under our <a href="/legal/privacy">privacy notice</a>.</p>
    </LegalSection>
  </LegalDocument>;
}
