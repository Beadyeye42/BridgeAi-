...
import { Activity, Building2, CreditCard, FileText, FolderTree, LayoutDashboard, MapPin, ShieldAlert } from "lucide-react";
import { BrandMark } from "@/components/brand-mark";

const links=[["Overview","/admin",LayoutDashboard],["Suppliers","/admin/suppliers",Building2],["Quote requests","/admin/requests",FileText],["Industries","/admin/categories",FolderTree],["Membership & matching","/admin/membership",CreditCard],["Coverage areas","/admin/coverage",MapPin],["Activity logs","/admin/audit",Activity],["System events","/admin/system",ShieldAlert]] as const;
