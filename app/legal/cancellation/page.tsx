...
export const metadata: Metadata = { title: "Cancellation policy | Bridge AI", description: "How Bridge AI supplier subscriptions can be changed or cancelled." };

export default function CancellationPage() {
  return <LegalDocument title="Subscription and cancellation policy" summary="A clear explanation of billing, plan changes, cancellation, access at the end of a paid period and refunds for Bridge AI supplier memberships.">
    <LegalSection id="scope" title="1. Business subscriptions">
      <p>Bridge AI supplier memberships are business-to-business monthly subscriptions. Customers requesting quotations through WhatsApp do not hold portal subscriptions and are not charged a Bridge AI request fee under the current service.</p>
    </LegalSection>
    ...
    <LegalSection id="timing" title="3. When cancellation takes effect">
      <p>Cancellation normally takes effect at the end of the current paid monthly period. The Supplier can continue using the paid plan until that date. After the period ends, it loses access to new opportunities and cannot submit new quotations. Historical and audit records may remain available to Bridge AI where needed for accounting, disputes, security or legal obligations.</p>
    </LegalSection>
    ...
    <LegalSection id="changes" title="5. Upgrades, downgrades and failed payments">
      <p>Stripe shows any immediate prorated charge or credit before a plan change is confirmed. A lower plan may require the Supplier to reduce its selected coverage or active opportunities to that plan’s limits. If payment fails, Stripe may retry it and Bridge AI may restrict access when the paid period or any permitted grace period ends.</p>
    </LegalSection>
    ...
    <LegalSection id="customer-requests" title="7. Cancelling a WhatsApp request">
      <p>A customer can tell Bridge AI to cancel a current draft in WhatsApp before it is published. Once a supplier and customer have entered their own contract, cancellation of that order is governed by the supplier’s terms, not this subscription policy. See the <Link href="/legal/customer-terms">customer terms</Link>.</p>
    </LegalSection>
  </LegalDocument>;
}
