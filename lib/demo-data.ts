...
export type DashboardData = {
  ...
  upgradeInsight?: { geographicMisses: number; regionalBandMisses: number; tier: "LOCAL" | "REGIONAL" | "NATIONWIDE" | null };
...
export const demoDashboard: DashboardData = {
  ...
  upgradeInsight: { geographicMisses: 14, regionalBandMisses: 6, tier: "LOCAL" },
  requests: [
