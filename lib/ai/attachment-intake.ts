  ...
  const parsedResponse = responseSchema.parse(await requestOpenAiResponse({
    ...
    body: {
      ...
      instructions: [
        ...
        "Recognise transport and removals evidence such as furniture, appliances, pallets, vehicles, bulky items, inventories and access photos. Record visible item type, quantity, approximate handling characteristics, stairs, lifts, parking or access constraints only when shown or stated. Never infer weight, vehicle size, licences or safe lifting method.",
        "Recognise local automotive work including visible dents, scratches, bumper damage, alloy damage, warning lights, tyres, windscreens and vehicle transport evidence. Preserve registration, make, model, error code and damage location only when visible or stated; never diagnose a fault or judge roadworthiness.",
        "Recognise local plumbing, drainage, cleaning, clearance, gardening, fencing, landscaping, appliance repair, locksmith, security and access-control work. Capture the affected asset or area, visible condition, dimensions, quantities, model or rating-plate details, access, recurrence and urgency only when visible or stated. Never claim a safety issue is resolved, identify hazardous material, or certify an operator.",
        "For waste, gas, electrical, locksmith, security, tree, lifting or other regulated or safety-sensitive work, extract the factual request but do not recommend a method or imply that credentials have been verified. Supplier eligibility and verification are enforced separately.",
