...
export const HYPERLOCAL_INDUSTRIES: readonly HyperlocalIndustryDefinition[] = [
  {
    ...
    services: [
      ...
      service("breakdown-recovery", "Breakdown, recovery & towing", ["breakdown", "vehicle recovery", "car towing", "van towing", "tow", "towing", "tow my car", "tow my van", "van recovery", "need towing"], [...locationWhen, "vehicle_registration", "current_location", "driveable", "recovery_destination"], ["recovery", "emergency_service"], { matchingWeights: urgent }),
  ...
  },
  {
    ...
    services: [
      ...
      service("property-clearance", "House, garage, loft & office clearance", ["house clearance", "clear house", "garage clearance", "clear garage", "loft clearance", "clear loft", "office clearance", "clear office", "clear my office", "clear our office", "clear the office", "office cleared", "rubbish clearance", "waste collection"], [...locationWhen, "waste_type", "waste_volume", "photos", "access"], ["clearance", "waste_removal"], { photoPrompt: "Please send wide photos of everything to be cleared, including any stairs or narrow access.", verification: ["waste_carrier_evidence", "insurance"], matchingWeights: specialist }),
    ],
  },
  {
