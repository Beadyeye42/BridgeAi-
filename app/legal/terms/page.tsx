...
export const metadata: Metadata = { title: "Supplier terms | Bridge-iT", description: "Terms for approved suppliers using the Bridge-iT portal." };

export default function TermsPage() {
  return <LegalDocument title="Supplier terms" summary="These business-to-business terms govern supplier applications, memberships, quote access and use of the Bridge-iT portal.">
    <LegalSection id="parties" title="1. About these terms">
      <p>These terms form an agreement between {BRIDGE_AI_COMPANY.name} (“Bridge-iT”, “we”, “us”) and the company applying for or using a supplier workspace (“Supplier”, “you”). The person accepting them confirms that they are at least 18 and authorised to bind the Supplier.</p>
    </LegalSection>

    <LegalSection id="service" title="2. What Bridge-iT provides">
      <p>Bridge-iT turns customer WhatsApp enquiries and supporting files into structured requests and matches them to eligible suppliers. It provides a secure workspace for reviewing opportunities and submitting quotations. Bridge-iT is an intermediary, not the manufacturer, installer, designer, engineer, merchant or customer.</p>
    ...
    <LegalSection id="liability" title="10. Responsibility and liability">
      <p>Nothing in these terms excludes liability that cannot lawfully be excluded, including liability for death or personal injury caused by negligence, fraud or fraudulent misrepresentation. Subject to that, Bridge-iT is not responsible for indirect or consequential loss, loss of profit, revenue, opportunity, data or goodwill, or the acts, products or services of customers, suppliers or third parties.</p>
    ...
    <LegalSection id="general" title="11. General terms">
      <p>The Supplier keeps ownership of its materials and grants us the rights needed to host, process and transmit them for the service. We own Bridge-iT, its software and branding. If part of these terms is unenforceable, the rest remains effective. Delay in enforcing a right is not a waiver.</p>
