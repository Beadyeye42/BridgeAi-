...
Founding supplier membership is limited to the first 100 approved companies. PostgreSQL allocates immutable places transactionally during approval. Stripe charges £29.99 plus VAT for the first six monthly billing periods and then £49.99 plus VAT per month through a two-phase Subscription Schedule. There are no introduction or winning fees.
